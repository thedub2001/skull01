```mermaid
    flowchart TD
        ...
        %% --- LocalDB ---
        LocalDB -->|export/import| LocalState["React State: nodes array, links array, visualLinks array"]

        %% --- RemoteDB ---
        RemoteDB -->|fetchNodes/fetchLinks/fetchVisualLinks| RemoteState["React State: nodes array, links array, visualLinks array"]
